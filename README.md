...
- [SDK Features present in the Demo Application Source Code](#sdk-features-present-in-the-demo-application-source-code)
- [Compatibility](#compatibility)
- [Supported Protocols](#supported-protocols)
- [SDK Installation](#sdk-installation)
- [Getting Started with the Code](#getting-started-with-the-code)
  - [Enable Local Inventory Support](#enable-local-inventory-support)
  - [Events to Register](#events-to-register)
...
- [OpenVPN Dialing Using Wintun Adapter](#openvpn-dialing-using-wintun-adapter)
  - [Steps to Enable Wintun Adapter for OpenVPN](#steps-to-enable-wintun-adapter-for-openvpn)
- [Pause and Resume VPN Feature](#pause-and-resume-vpn-feature)
  - [Feature Overview](#feature-overview)
    - [VPN Pause Modes](#vpn-pause-modes)
    - [Key Rules & Conditions](#key-rules--conditions)
  - [Events & Methods](#events--methods)
    - [Events](#events)
      - [OnVPNPaused](#onvpnpaused)
    - [Pause Method](#pause-method)
    - [Resume Method](#resume-method)
  - [VPN State Management](#vpn-state-management)
  - [Conclusion](#conclusion)
- [Tracker and Ad Blocker Feature](#tracker-and-ad-blocker-feature)
  - [About This Feature](#about-this-feature)
  - [Integration on Windows](#integration-on-windows)
    - [1. Define Features](#1-define-features)
    - [2. Request Features](#2-request-features)
    - [3. Observe Status and Data](#3-observe-status-and-data)
    - [4. Status Definitions](#4-status-definitions)
    - [5. Data Monitoring](#5-data-monitoring)
    - [6. Requested Status](#6-requested-status)
  - [Conclusion](#conclusion-1)
- [Local LAN Access Feature](#local-lan-access-feature)
  - [Overview](#overview)
